...
function darID(t: Tarea): string {
    return (cantidadTareas + 1) + "ID";
}
  function pedirTitulo(t: Tarea): void {
  t.titulo = prompt("Título de la tarea: ");
}

function pedirDescripcion(t: Tarea): void {
  t.descripcion = prompt("Descripción: ");
}

function pedirDificultad(t: Tarea): void {
  do {
    console.log("\n1 = § = Facilisimo\n2 = §§ = Facil\n3 = §§§ = Medio\n4 = §§§§ = Complicado\n5 = §§§§§ = Dificilisimo");
...
function pedirEstado(t: Tarea): void {
  let opcion: number;
  do {
    console.log("\n1 = Pendiente\n2 = En curso\n3 = Terminada");
...
function pedirFechaVencimiento(t: Tarea): void {
...
function mostrarResumen(t: Tarea): void {
  console.log("----------------------------------------");
